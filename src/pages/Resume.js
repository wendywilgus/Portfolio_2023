        ...
        <div class="container mt-5">
          ...
          <div class="row">
            <div class="col-md-4">
              ...
              <div class="col-md-8">
                <p>
                  <strong>Website built in WordPress</strong>for a 48in48 volunteer event.  Planned design using Figma.  Worked with a team for project management, production, and build. Contributed after event to complete Q/A and final tasks on additional websites for other nonprofits.  
                </p>
              </div>
